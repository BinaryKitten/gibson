...
class InjectTemplateListener extends AbstractListenerAggregate
{
    ...
    {
        $this->listeners[] = $events->attach(MvcEvent::EVENT_DISPATCH, array($this, 'injectTemplate'), -95);
    }
    ...
    public function injectTemplate(MvcEvent $e)
    {
        ...
        if (!$controller || $controller instanceof AbstractCrudController || (is_string($controller) && $controller == 'Arazu\Controller\AbstractCrudController')) {
